"""
Splits the 9-band predictor stack (`outputs/probability_map/predictor_stack_v4.tif`) into
9 individual single-band GeoTIFFs, so each predictor can be opened/symbolized on its own
...
the geemap export -- see '../README.md', "Technical sidenotes"), but every
...
SRC_TIF = HERE.parent / "predictor_stack_v4.tif"
